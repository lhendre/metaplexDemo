...
fn auctioneer_execute_sale_logic<'info>(
    ...
    //Determines if the mint is custom or from the contract.
    ...
    //Determines whos paying the fee
    ...
    if is_native {
        ...
        if diff != buyer_price {
            ...
            //transfers crypto to pay shortfall
            invoke_signed(
    ...
    //pays fees to auction and creator
