...
//YOUTUBE Account process
fn parse_accounts<'a, 'b: 'a>(
    program_id: &Pubkey,
    accounts: &'a [AccountInfo<'b>],
) -> Result<Accounts<'a, 'b>, ProgramError> {
    let account_iter = &mut accounts.iter();
    //Pulls ut account info
    ...
    //calls okay with accounts as this is what it passes back
    Ok(accounts)
}

//YOUTUBE - Bid placing and crypto transfer
...
pub fn place_bid<'r, 'b: 'r>(
    ...
    //Example of accessing a function and data from another contract
    ...
    if accounts.bidder_pot.data_is_empty() {
        ...
        //Creates token account to hold bid.
